...
const invalidJsonWebEncryptionHeaderParameters: any[] = [
  undefined,
  null,
  true,
  1,
...
describe('createJsonWebEncryptionHeader()', () => {
  const parameters: JsonWebEncryptionHeaderParameters = { alg: 'A128GCMKW', enc: 'A128CBC-HS256' };

  const parametersWithJwkAndX509Chain: JsonWebEncryptionHeaderParameters = {
    alg: 'RSA-OAEP',
    enc: 'A128GCM',
    jwk: {
      kty: 'RSA',
  ...
  it.each(invalidJsonWebEncryptionHeaderParameters)(
    'should throw when the provided JSON Web Encryption Header Parameters is invalid.',
    async (parameters) => {
      await expect(createJsonWebEncryptionHeader(parameters)).rejects.toThrowWithMessage(
        TypeError,
        'The provided JSON Web Encryption Header Parameters is invalid.',
      );
    },
  );

  it('should throw when the provided JSON Web Encryption Header Parameters are invalid.', async () => {
    await expect(createJsonWebEncryptionHeader({ alg: 'HS256' } as any)).rejects.toThrow(InvalidJoseHeaderError);
  });

  it('should throw when failing to get a JSON Web Key from the provided JSON Web Encryption Header Parameters.', async () => {
    await expect(createJsonWebEncryptionHeader({ ...parameters, jwk: { kty: 'oct', e: 'AQAB' } })).rejects.toThrow(
      InvalidJoseHeaderError,
    );
  });

  it('should throw when failing to get a X.509 Certificate Chain from the provided JSON Web Encryption Header Parameters.', async () => {
    await expect(createJsonWebEncryptionHeader({ ...parameters, x5c: ['abcdef0123456789'] })).rejects.toThrow(
  ...
  it('should return a JSON Web Encryption Header without a JSON Web Key and an X.509 Certificate Chain.', async () => {
    let header!: JsonWebEncryptionHeader;

    await expect(async () => (header = await createJsonWebEncryptionHeader(parameters))).resolves.not.toThrow();
  ...
  it('should return a JSON Web Encryption Header with a JSON Web Key from the provided JSON Web Encryption Header Parameter "jku".', async () => {
    let header!: JsonWebEncryptionHeader;
    ...
    const params: JsonWebEncryptionHeaderParameters = { ...parameters, jku: 'http://jku-url.com', kid: 'rsa-key' };

    await expect(async () => (header = await createJsonWebEncryptionHeader(params))).resolves.not.toThrow();
  ...
  it('should return a JSON Web Encryption Header with a JSON Web Key from the provided JSON Web Encryption Header Parameter "jwk".', async () => {
    let header!: JsonWebEncryptionHeader;
  ...
  it('should return a JSON Web Encryption Header with an X.509 Certificate Chain from the provided JSON Web Encryption Header Parameter "x5u".', async () => {
    let header!: JsonWebEncryptionHeader;
    ...
    const params: JsonWebEncryptionHeaderParameters = { ...parameters, x5u: 'http://x5u-url.com' };
  ...
  it('should return a JSON Web Encryption Header with an X.509 Certificate Chain from the provided JSON Web Encryption Header Parameter "x5c".', async () => {
    let header!: JsonWebEncryptionHeader;
  ...
  it('should return a JSON Web Encryption Header with a JSON Web Key and an X.509 Certificate Chain.', async () => {
    let header!: JsonWebEncryptionHeader;

    await expect(async () => {
      header = await createJsonWebEncryptionHeader(parametersWithJwkAndX509Chain);
